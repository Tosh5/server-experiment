...
io.on("connection", (socket) =>{
    ...
    socket.on('send_start', (msg) =>{
        ...
        const gameCount = async () =>{
            ...
            socket.on("send_myindex", (roomId, data)=>{
                ...
                if (isGameActive){
                    ...
                    // let pre_geneIndex = Math.round(sum / index_bin.length)

                    // function calcGeneIndex(isGameActive) {
                    //     return (isGameActive ? pre_geneIndex : '0');
                    // }
                    // let geneIndex = calcGeneIndex(isGameActive)
